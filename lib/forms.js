...
exports.createForm = function(parentForm) {
    ...
    // For each of the actions of the parent, create a new local field property.
    Object.keys(p.prototype.actions).forEach(function(key) {
        newForm.prototype.actions[key] = p.prototype.actions[key]
    });
