...
exports.min = function(val) {
    return function(form, field, callback) {
        ...
        else callback('Please enter a value greater than or equal to ' + val + '.');
    }
};
...
exports.max = function(val) {
    return function(form, field, callback) {
        if (field.data <= val) callback();
        else callback('Please enter a value less than or equal to ' + val + '.');
    }
};
...
exports.range = function(min, max) {
    return function(form, field, callback) {
        ...
        else callback('Please enter a value between ' + min + ' and ' + max + '.');
    }
};

exports.minlength = function(val) {
    return function(form, field, callback) {
        if (field.data.length >= val) callback();
        else callback('Please enter at least ' + val + ' characters.');
    };
};
...
exports.maxlength = function(val) {
    return function(form, field, callback) {
        if (field.data.length <= val) callback();
        else callback('Please enter no more than ' + val + ' characters.');
    };
};
...
exports.regexp = function(re, message) {
    ...
    return function(form, field, callback) {
        ...
        else callback(message || 'Invalid format.');
    };
};
