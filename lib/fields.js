...
exports.string = function(opt){
    ...
    f.bind = function(raw_data){
        // TODO: this is very raw refactoring that doesn't clone the field
        // when binding it. We will want to bring back cloning for keeping the original
        // form around for e. g. CSRF protection measures like form tokens.
        f.value = raw_data;
        ...
        f.validate = function(form, callback){
            if(raw_data === '' || raw_data === null || raw_data === undefined){
                ...
                if(f.required) f.error = 'This field is required.';
