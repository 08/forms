...
exports.string = function(opt){
    ...
    f.__defineGetter__('value', function() {
      return this.form.instance[this.key] || this.form.defaults[this.key] || '';
    });
    ...
    f.validate = function(form){
        ...
        if(raw_data === '' || raw_data === null || raw_data === undefined){
            ...
            if (f.required) {
              f.form.errors[f.key] =  f.label + ' is required';
            }
        }
        else {
            (f.validators || []).forEach( function(key) {
                this.validators[key].call(this, this.form, this, function(err) {
                   if (err !== undefined) {
                       field.form.errors[field.key] = err;
                   }
                });
            }, this);
        }
